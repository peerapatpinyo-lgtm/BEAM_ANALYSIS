...
                        
                        d_t = h_mm - (cover_mm + 9 + t_db/2 + (t_lay-1)*(25 + t_db)/2) # 9mm stirrup as default for d calc
...
                        # --- 3. SHEAR STIRRUPS (กู้คืนส่วนที่หายไป) ---
...
                    # เก็บข้อมูลลง List ให้ครบถ้วน (ห้ามตกหล่นแม้แต่ Key เดียว)
...
        # ================= TAB 1: ANALYSIS RESULTS (กู้คืน Tab 1) =================
        with tab1:
