        ...
        try:
            with st.spinner("Calculating Stiffness Matrix & Designing..."):
                ...
                with c2:
                    ...
                    st.info(f"Max Shear (V_max): **{df_res['shear'].abs().max():,.2f} {params['u_force']}**")
                    st.info(f"Max Moment (M_max): **{df_res['moment'].abs().max():,.2f} {params['u_force']}-{params['u_len']}**")
